    ...
    case 'operator_day3_tips':
      return {
        ...
        html: base(`
          ...
          <p style="line-height:1.6;color:#8A9BB5;">Hey ${data.name}, it&apos;s been a few days — here&apos;s how top operators on Rentivo fill their calendars:</p>
    ...
    case 'operator_day7_pricing':
      return {
        ...
        html: base(`
          ...
          <p style="line-height:1.6;color:#8A9BB5;">Hi ${data.name}, the #1 reason operators don&apos;t get bookings is pricing mismatch. We analyzed your market in <strong style="color:#F5F0E8;">${data.city ?? 'your city'}</strong>:</p>
          <div style="background:#0A1628;border-radius:12px;padding:20px;margin:16px 0;color:#8A9BB5;">
            <div>Market average: <strong style="color:${brandColor};">&euro;${data.avg_price ?? '—'}/day</strong></div>
            <div>Your price: <strong style="color:#F5F0E8;">&euro;${data.your_price ?? '—'}/day</strong></div>
          </div>
    ...
    case 'operator_day14_growth':
      return {
        ...
        html: base(`
          ...
          <p style="line-height:1.6;color:#8A9BB5;">Hi ${data.name}, two weeks in — let&apos;s make sure you&apos;re set up for maximum visibility:</p>
          <div style="background:#0A1628;border-radius:12px;padding:20px;margin:16px 0;">
