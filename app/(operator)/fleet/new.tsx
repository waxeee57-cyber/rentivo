      ...
      <ScrollView contentContainerStyle={styles.content}>
        {step === 1 && (
          <>
            ...
            <Button title="Continue →" onPress={() => setStep(2)} fullWidth style={{ marginTop: Spacing.md }} />
          </>
        )}
        ...
        {step === 2 && (
          <>
            ...
            <Button title="Continue →" onPress={() => setStep(3)} fullWidth style={{ marginTop: Spacing.md }} />
          </>
        )}
