...
export const MOCK_OPERATOR: Operator = {
  ...
  description: 'Car rental in Marbella from €50/day. Instant confirmation, deposit shown before you pay. 0 double bookings since launch.',
  logo_url: null,
...
export const MOCK_LISTINGS: Listing[] = [
  {
    ...
    description: '2023 BMW 3 Series, automatic, 5 seats. Leather, GPS and Bluetooth. Optional damage waiver available at checkout.',
    category: 'car',
    subcategory: null,
    price_per_day: 150,
    price_per_week: 950,
  ...
  },
  {
    ...
    description: 'Four-seat convertible. Roof down for the coastal road between Marbella and Ronda.',
    category: 'car',
    subcategory: null,
    price_per_day: 120,
    price_per_week: 780,
  ...
  },
  {
    ...
    description: '2024 Mercedes C-Class, 5 seats, sunroof. Automatic, GPS and heated leather.',
    category: 'car',
    subcategory: null,
    price_per_day: 175,
    price_per_week: 1100,
